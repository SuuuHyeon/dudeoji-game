...
export const RAPID_CLICK_LIMIT = 12;
export const MIN_REACTION_TIME_MS = 100;
export const REACTION_TIME_STD_DEV_THRESHOLD = 15;
export const REACTION_TIME_SAMPLE_SIZE = 10;
export const REACTION_TIME_MAX_HISTORY = 20;
export const CLICK_HISTORY_SIZE = 10;
export const TELEPORT_MOVE_THRESHOLD = 2;
export const TELEPORT_STRIKE_LIMIT = 4;
export const COORDINATE_STD_DEV_THRESHOLD = 0.02;
